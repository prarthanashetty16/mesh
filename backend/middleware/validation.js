...
const validateRegistration = (req, res, next) => {
  ...
  // Only name, email, password are strictly required to register
...
const validateTaskCreation = (req, res, next) => {
  ...
  if (!title || !price || latitude === undefined || longitude === undefined) {
    return res.status(400).json({
      success: false,
      message: 'Missing required fields: title, price, latitude, longitude',
    });
  }
